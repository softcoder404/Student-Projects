...
def doCalculation(slip):
    ...
    z_d = (z1 * zm) + (z1 * z2) + (z2 * zm)
    z1_n = 1.0 * (zm + z2)
    ans=z1_n/z_d
    print(z_d)
    print(z1_n)
    print(ans)
    print(cmath.polar(ans))
    ...
    final_result['i2'] = i2
    final_result['im'] = im
    final_result['i_1_angle'] = i1[1]
    final_result['i_2_angle'] = i2[1]
    final_result['i_m_angle'] = im[1]
...
def graphWindow():
    ...
    #label
    slip_title = Label(top,text="Enter Six Assumed Slip Value",font=('Arial',12,'bold'),fg="teal")
...
def finalWindow(s,p,t,e,i):
    ...
    top.title("Draw Graph Window")
    #label
    slip_title = Label(top,text="Draw Graph Window",font=('Arial',12,'bold'),fg="teal")
    ...
    #Buttons
    op_button = Button(top,text='Power Output Vs Slip',padx=10,pady=10,command=lambda: drawSP(s,p))
    t_button = Button(top,text='Torque Vs Slip',padx=10,pady=10,command=lambda: drawST(s,t))
    e_button = Button(top,text='Efficiency Vs Slip',padx=10,pady=10,command=lambda: drawSE(s,e))
    i_button = Button(top,text='Power Input Vs Slip',padx=10,pady=10,command=lambda: drawSI(s,i))
    #mixed buttons
    et_button = Button(top,text='Torque Vs Efficiency',padx=10,pady=10,command=lambda: drawET(e,t))
    eo_button = Button(top,text='Power Output Vs Efficiency',padx=10,pady=10,command=lambda: drawEO(e,p))
    ei_button = Button(top,text='Power Input Vs Efficiency',padx=10,pady=10,command=lambda: drawEI(e,i))
    io_button = Button(top,text='Output Power Vs Input Power',padx=10,pady=10,command=lambda: drawIO(i,p))
    to_button = Button(top,text='Output Power Vs Torque',padx=10,pady=10,command=lambda: drawTO(t,p))
    ti_button = Button(top,text='Input Power Vs Torque',padx=10,pady=10,command=lambda: drawTI(t,i))
...
def computeWindow():
    ...
    #result2 label
    calculation_title = Label(top,text=" CALCULATED RESULTS ",font=('Arial',12,'bold'),fg="teal")
    ...
    i1_ampere_label = Label(top,text=" Or " +str(res['i_1_A']) +" A" +" ∠ "+str(res['i_1_angle']))
    i2_ampere_label = Label(top,text=" Or " +str(res['i_2_A']) +" A"+" ∠ "+str(res['i_2_angle']))
    im_ampere_label = Label(top,text=" Or " +str(res['i_m_A']) +" A"+" ∠ "+str(res['i_m_angle']))
...
title = Label(root,text="A STUDY ON THE PERFORMANCE OF INDUCTION MOTORS",font=('Arial',12,'bold'),fg='teal')
